...
while True:
   ...
   if user_menu == "yes" or user_menu == "Yes":
      ...
      print()
      print("Enter 'area of circle' or '10' to find the area of a circle")
      print()
      print("Enter 'circumference of circle' or '11' to find the area of a circle")
      print()
      print("Enter 'volume of cube' or '12' to find volume of cube")
      print()
      print("Enter 'volume of cuboid' or '13' to find volume of cuboid")
      print()
      print("Enter 'volume of prism' or '14' to fine volume of prism")
      print()
      print("Enter 'volume of closed cylinder' or '15' to find volume of closed cylinder")
      print()
